...
<div class="center">
    ...
    <form action="login_check.php" method="post">
        <table class="tab">
            <tr><td> <label for="username" class="lab">用户名：</label><input type="text" name="username" value="<?php  echo $username; ?>" pattern="^[1-9]\d{5}[1-9]\d{3}((0[1-9])|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$" placeholder="用户名为身份证号" ><span>用户名为身份证号码</span></td></tr>
